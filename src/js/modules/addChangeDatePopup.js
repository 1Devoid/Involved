function addChangeDatePopup() {
  if (document.getElementById('change-date-popup')) {
    function toggleExpirationFields() {
      let noExpireCheckbox = document.getElementById('change-date-no-expire');
      let expireDateField = document.getElementById('change-date-expire-date');
      let expireTextField = document.getElementById('change-date-expire-text');
      let expireDateBtn = document.querySelector(
        '#change-date-expire-date ~ button'
      );
      let togglers = document.getElementById('change-date-togglers');
    ...
    document
      .getElementById('change-date-days')
      .addEventListener('change', toggleExpirationType);

    var startDateInput = document.getElementById('change-date-start-date');
    ...
    startDateInput.addEventListener('input', function () {
      ...
      const inputDateDelegation = document.querySelector(
        '#change-date-start-date ~ .group[data-te-input-notch-ref]'
      );
      const inputLabel = document.querySelector(
        '#change-date-start-date-label'
      );
      const errorMsg = document.querySelector('#change-date-start-date-error');
...
export default addChangeDatePopup;
